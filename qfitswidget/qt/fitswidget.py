...
class Ui_FitsWidget(object):
    def setupUi(self, FitsWidget):
        ...
        self.widgetZoom = QtWidgets.QWidget(FitsWidget)
        self.widgetZoom.setMinimumSize(QtCore.QSize(101, 101))
        self.widgetZoom.setMaximumSize(QtCore.QSize(101, 101))
        self.widgetZoom.setObjectName("widgetZoom")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.widgetZoom)
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.horizontalLayout_4.addWidget(self.widgetZoom)
