...
class Ui_FitsView(object):
    def setupUi(self, FitsView):
        ...
        self.gridLayout.addWidget(self.textImageY, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.textWorldRA, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.textImageX, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.textPixelValue, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.textWorldDec, 2, 4, 1, 1)
        ...
        self.frameToolBar.setFrameShape(QtWidgets.QFrame.StyledPanel)
